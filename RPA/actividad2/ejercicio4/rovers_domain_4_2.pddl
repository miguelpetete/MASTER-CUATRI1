(define (domain Rover5)
    ...
    (:action sample_soil
        ...
        :precondition (and (at ?r ?w) (at_soil_sample ?w) (equipped_for_soil_analysis ?r) (store_of ?s ?r) (empty ?s) (or (battery_4 ?r) (battery_3 ?r) (battery_2 ?r) (battery_1 ?r)))
    ...
    (:action sample_rock
        :parameters (?r - rover ?s - store ?w - waypoint)
        :precondition (and (at ?r ?w) (at_rock_sample ?w) (equipped_for_rock_analysis ?r) (store_of ?s ?r) (empty ?s) (or (battery_4 ?r) (battery_3 ?r) (battery_2 ?r) (battery_1 ?r)))
    ...
    (:action calibrate
        ...
        :precondition (and (at ?r ?w) (equipped_for_imaging ?r) (on_board ?c ?r) (calibration_target ?c ?o) (visible_from ?o ?w))
        :effect (calibrated ?c ?r)
    )
    (:action take_image
        :parameters (?r - rover ?w - waypoint ?o - objective ?c - camera ?m - mode)
        :precondition (and (at ?r ?w) (calibrated ?c ?r) (on_board ?c ?r) (equipped_for_imaging ?r) (supports ?c ?m) (visible_from ?o ?w))
        :effect (and (have_image ?r ?o ?m) (not (calibrated ?c ?r)))
    )
    (:action communicate_soil_data
        :parameters (?r - rover ?l - lander ?p - waypoint ?rw - waypoint ?lw - waypoint)
        :precondition (and (at ?r ?rw) (have_soil_analysis ?r ?p) (at_lander ?l ?lw) (visible ?rw ?lw) (available ?r) (channel_free ?l))
        :effect (and (communicated_soil_data ?p) (not (channel_free ?l)) (channel_free ?l))
    )
    (:action communicate_rock_data
        :parameters (?r - rover ?l - lander ?p - waypoint ?rw - waypoint ?lw - waypoint)
        :precondition (and (at ?r ?rw) (have_rock_analysis ?r ?p) (at_lander ?l ?lw) (visible ?rw ?lw) (available ?r) (channel_free ?l))
        :effect (and (communicated_rock_data ?p) (not (channel_free ?l)) (channel_free ?l))
    )
    (:action communicate_image_data
        :parameters (?r - rover ?l - lander ?o - objective ?m - mode ?rw - waypoint ?lw - waypoint)
        :precondition (and (at ?r ?rw) (have_image ?r ?o ?m) (at_lander ?l ?lw) (visible ?rw ?lw) (available ?r) (channel_free ?l))
        :effect (and (communicated_image_data ?o ?m) (not (channel_free ?l)) (channel_free ?l))
    )
)